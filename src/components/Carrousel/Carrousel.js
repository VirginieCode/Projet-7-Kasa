...
export default function Carrousel({ slides }) {
  ...
  const previousFleche = <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white" class="bi bi-chevron-left" viewBox="0 0 16 16">
  ...
  const nextFleche = <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white" class="bi bi-chevron-right" viewBox="0 0 16 16">
